...
module.exports = {
    ...
    serviceAvaibility: async(req, res) => {
        ...
        try {
            ...
            res.status(200).json({status: false, message: "Availabiltiy successfully toggled", isAvailable: restaurant.isAvailable})
        } catch (error) {
    ...
    deleteRestaurant: async(req, res) => {
        ...
        try {
            ...
            res.status(201).json({status: true, message: "Restaurant sucessfully deleted"})
        } catch (error) {
